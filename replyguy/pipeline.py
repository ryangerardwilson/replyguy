...
def _bookmark_system_prompt(reply_count: int) -> str:
    return (
        ...
        "Rules:\n"
        "- The recommended reply should be the best line overall, not the safest one.\n"
        "- Alternates must differ in rhetorical move, cadence, and temperature, not just wording.\n"
        "- When the post allows it, vary across reply families such as warm sharpener, scalpel, operator, aphorism, deadpan, or playful barb.\n"
        ...
        "- In `why_it_works`, briefly explain the winning move and mention the style family when useful.\n"
